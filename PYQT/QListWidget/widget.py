from PySide6.QtWidgets import QPushButton, QListWidget, QHBoxLayout, QVBoxLayout, QWidget, QButtonGroup, QAbstractItemView
...
class Widget(QWidget):
    ...
    def current_item_changed(self,item):
        if item is None:
            print("no item present in the list")
        else:
